...
# Build the notebook from scratch to ensure valid JSON
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "source": [
                "# ============================================================\n",
                "# CELL 3: PREPARE DATA FROM LOCAL corpus.txt\n",
                "# ============================================================\n",
                "import random\n",
                "\n",
                ...
                "    content = f.read()\n",
                "\n",
                "# Split by double newline (blank line between stories)\n",
